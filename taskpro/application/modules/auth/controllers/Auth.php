...
class Auth extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			$this->render_page('auth/index', array_merge($this->data,$this->pengaturan));
		}
	}
	...
	public function login($param=null)
	{
		...
		else
		{
			...
			$this->load->view('auth/login', array_merge($this->data,$this->pengaturan));
		}
	}

	// log the user out
	public function logout($param=null,$notif)
	{
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			// render
			$this->render_page('auth/change_password', array_merge($this->data,$this->pengaturan));
		}
		else
		{
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->_render_page('auth/forgot_password', array_merge($this->data,$this->pengaturan));
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				// render
				$this->_render_page('auth/reset_password', array_merge($this->data,$this->pengaturan));
			}
			else
			{
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->render_page('auth/deactivate_user',array_merge($this->data,$this->pengaturan));
		}
		else
		{
	...
	public function create_user()
    {
        ...
        else
        {
            ...
            $this->render_page('auth/create_user',array_merge($this->data,$this->pengaturan));
        }
    }
	...
	public function edit_user($id)
	{
		...
		$this->render_page('auth/edit_user',array_merge($this->data,$this->pengaturan));
	}
	...
	public function create_group()
	{
		...
		else
		{
			...
			$this->render_page('auth/create_group', array_merge($this->data,$this->pengaturan));
		}
	}
	...
	public function edit_group($id)
	{
		...
		$this->render_page('auth/edit_group', array_merge($this->data,$this->pengaturan));
	}
