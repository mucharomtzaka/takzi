      ...
      <div class="box">
       <div class="col-md-12">
          <div class="box box-success">
            ...
            <div class="box-body">
                <div class="row">
                     <?php echo form_open_multipart('home/setting/postset');?>
                      <input type="hidden" class="form-control"  name="id" value="<?php echo $id_sett;?>">
                  <div class="col-md-5">
                  ...
                  <div class="col-md-5">
                     ...
                     <div class="form-group has-feedback">
                    <image src="<?php echo base_url('bootasset/uploadImages');?>/<?php echo $image_favicon;?>" id="output2" width="150" height="150"></image>
                     ...
                     <div class="form-group has-feedback">
                       <image src="<?php echo base_url('bootasset/uploadImages');?>/<?php echo $backgrounds;?>" id="output3" width="150" height="150"></image>
