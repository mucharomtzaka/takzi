 ...
 */
$config['site_title']                 = "TaskproLTE.com";       // Site Title, example.com
$config['admin_email']                = "mucharomtzaka@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';
$config['programmer_group']           = 'IT-Support';              // Default administrators group, use name
...
$config['message_start_delimiter'] = '<div class="span4 offset4 alert alert-info"><button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="span4 offset4 alert alert-error"><button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>';		// Error message start delimiter
